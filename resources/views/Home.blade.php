...
<body class="bg-gray-100">
    ...
    <section class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <img src="asset/Baterai_Sepeda.png" alt="Baterai" class="w-full">
                <div class="p-3">
                    <h3 class="text-sm font-medium mb-2 line-clamp-2">AKI SEPEDA LISTRIK UWINFLY 12V/12AH (6-DZF-12) ORIGINAL 48V/12AH UWINFLY BERGARANSI</h3>
                    <p class="text-wattup font-bold">Rp250.000</p>
                    <div class="flex items-center mt-1">
                        <div class="flex text-yellow-400">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <img src="asset/Charger_Baterai.png" alt="Charger" class="w-full">
                <div class="p-3">
                    <h3 class="text-sm font-medium mb-2 line-clamp-2">Charger Sepeda Listrik 48V 12AH / Universal Charger Motor Listrik / Baterai Selis Scooter Elektrik Charger</h3>
                    <p class="text-wattup font-bold">Rp 68.500</p>
                    <div class="flex items-center mt-1">
                        <div class="flex text-yellow-400">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                        </div>
                        <span class="text-xs text-gray-500 ml-1">(2,890)</span>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">Banjarmasin</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <img src="asset/Rem_Speda.png" alt="Rem" class="w-full">
                <div class="p-3">
                    <h3 class="text-sm font-medium mb-2 line-clamp-2">Tuas rem hitam perak universal sepeda motor skuter listrik / tuas rem sekitar sepasang / tidak perlu membongkar</h3>
                    <p class="text-wattup font-bold">Rp34.900</p>
                    <div class="flex items-center mt-1">
                        <div class="flex text-yellow-400">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i>
                        </div>
                        <span class="text-xs text-gray-500 ml-1">(432)</span>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">Banjarmasin</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <img src="asset/Lampu_LED.png" alt="Lampu LED" class="w-full">
                <div class="p-3">
                    <h3 class="text-sm font-medium mb-2 line-clamp-2">Lampu Depan Sepeda SUBA EOS 6 Series – EOS610 – EOS620 – EOS630 – EOS640 Professional Bicycle Headlight</h3>
                    <p class="text-wattup font-bold">Rp279.200</p>
                    <div class="flex items-center mt-1">
                        <div class="flex text-yellow-400">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                        </div>
                        <span class="text-xs text-gray-500 ml-1">(789)</span>
                    </div>
                    <p class="text-xs text-gray-500 mt-1">Banjarmasin</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <img src="asset/Speedometer.png" alt="Lampu LED" class="w-full">
                <div class="p-3">
                    <h3 class="text-sm font-medium mb-2 line-clamp-2">SPIDOMETER LCD SEPEDA LISTRIK ORIGINAL EXOTIC GODA PASIFIC AGATHOS DLL</h3>
                    <p class="text-wattup font-bold">Rp193.500</p>
                    <div class="flex items-center mt-1">
                        <div class="flex text-yellow-400">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                        </div>
